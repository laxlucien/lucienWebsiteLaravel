...
<center>
    ...
    @if (session('status'))
        <h3 style="width: 60%; color: white; background-color: #0C0A09; padding: 10px; border-radius: 8px;">
            {{ session('status') }}
        </h3>
        <br>
    @endif

    <h1 style="width: 20%; color:white; background-color: #0C0A09; padding: 10px; border-radius: 8px;">Upload Photos -</h1>
    <br>
    <form class="align-items-center justify-content-center" action="{{ url('storePhotoUpload/'.$user->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            <h3><label for="title" style="color: white; background-color: #0C0A09; padding: 10px; border-radius: 8px; width: 20%;">Photo Title:</label></h3>
            <input class="form-control" type="text" id="title" name="title" placeholder="Photo Title..." required />
        </div>

        <div class="form-group">
            <h3><label for="description" style="color: white; background-color: #0C0A09; padding: 10px; border-radius: 8px; width: 20%;">Photo Description:</label></h3>
            <input class="form-control" type="text" id="description" name="description" placeholder="Photo description..." required />
        </div>

        <div class="form-group">
            <h3><label for="location" style="color: white; background-color: #0C0A09; padding: 10px; border-radius: 8px; width: 20%;">Photo Location:</label></h3>
            <input class="form-control" type="text" id="location" name="location" placeholder="Photo Location..." required />
        </div>

        <div class="form-group">
            <div><h3><label for="uploadedPhoto" style="color: white; background-color: #0C0A09; padding: 10px; border-radius: 8px; width: 20%;">Upload Photo:</label></h3></div>
    ...
    <h3 style="width: 20%; color:white; background-color: #0C0A09; padding: 10px; border-radius: 8px;">Disclaimers:</h3>

    <h3 style="width: 70%; color:white; background-color: #0C0A09; padding: 10px; border-radius: 8px;">
